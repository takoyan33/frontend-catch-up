...
export async function getAllSections(): Promise<{
  ...
  const results = await Promise.all([
    ...
    safeFeed(fetchZennTopicFeed("ai")),
    safeFeed(fetchZennTopicFeed("aws")),
    safeFeed(fetchZennTopicFeed("docker")),
    safeFeed(fetchZennTopicFeed("git")),
  ...
  const sections: Section[] = [
    ...
    { title: "Zenn（AI）", items: aiItems },
    { title: "Zenn（AWS）", items: awsItems },
    { title: "Zenn（Docker）", items: dockerItems },
    { title: "Zenn（Git）", items: gitItems },
